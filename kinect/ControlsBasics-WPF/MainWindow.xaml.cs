...
namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    public partial class MainWindow
    {
        ...
        public MainWindow()
        {
            ...
            var button1 = new KinectTileButton { Label = "Forward" };
            this.wrapPanel.Children.Add(button1);

            var button2 = new KinectTileButton { Label = "Backward" };
            this.wrapPanel.Children.Add(button2);

            var button3 = new KinectTileButton { Label = "Right" };
            this.wrapPanel.Children.Add(button3);

            var button4 = new KinectTileButton { Label = "Left" };
            this.wrapPanel.Children.Add(button4);

            var button5 = new KinectTileButton { Label = "Circle" };
            this.wrapPanel.Children.Add(button5);

            var button6 = new KinectTileButton { Label = "Stop" };
            this.wrapPanel.Children.Add(button6);
